...
!function (t, e) {
  ...
  function m(t) {
    var e, i;
    return t = (t + "").trim().toLowerCase(), (e = l.exec(t)) ? (i = e[1].length, e = parseInt(e[1], 16), 6 === i ? $(e) : 3 === i ? new M(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | 240 & e, (15 & e) << 4 | 15 & e, 1) : 8 === i ? N(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (255 & e) / 255) : 4 === i ? N(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | 240 & e, ((15 & e) << 4 | 15 & e) / 255) : null) : (e = u.exec(t)) ? new M(e[1], e[2], e[3], 1) : (e = c.exec(t)) ? new M(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, 1) : (e = g.exec(t)) ? N(e[1], e[2], e[3], e[4]) : (e = p.exec(t)) ? N(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, e[4]) : (e = f.exec(t)) ? j(e[1], e[2] / 100, e[3] / 100, 1) : (e = d.exec(t)) ? j(e[1], e[2] / 100, e[3] / 100, e[4]) : b.hasOwnProperty(t) ? $(b[t]) : "transparent" === t ? new M(NaN, NaN, NaN, 0) : null;
  }
  function $(t) {
  ...
  function k(t) {
    return t instanceof n || (t = m(t)), t ? new M((t = t.rgb()).r, t.g, t.b, t.opacity) : new M();
  }
  function x(t, e, i, n) {
  ...
  function j(t, e, i, n) {
    return n <= 0 ? t = e = i = NaN : i <= 0 || i >= 1 ? t = e = NaN : e <= 0 && (t = NaN), new I(t, e, i, n);
  }
  function O(t) {
    ...
    var e = (t = t.rgb()).r / 255,
      ...
      o = s - a,
      l = (s + a) / 2;
    return o ? (h = e === s ? (i - r) / o + 6 * (i < r) : i === s ? (r - e) / o + 2 : (e - i) / o + 4, o /= l < .5 ? s + a : 2 - s - a, h *= 60) : o = l > 0 && l < 1 ? 0 : h, new I(h, o, l, t.opacity);
  }
  function P(t, e, i, n) {
  ...
  e(n, m, {
    ...
    brighter(t) {
      return t = null == t ? a : Math.pow(a, t), new M(this.r * t, this.g * t, this.b * t, this.opacity);
    },
    darker(t) {
      return t = null == t ? r : Math.pow(r, t), new M(this.r * t, this.g * t, this.b * t, this.opacity);
    },
    rgb() {
      return this;
    },
    ...
    brighter(t) {
      return t = null == t ? a : Math.pow(a, t), new I(this.h, this.s, this.l * t, this.opacity);
    },
    darker(t) {
      return t = null == t ? r : Math.pow(r, t), new I(this.h, this.s, this.l * t, this.opacity);
    },
    rgb() {
      var t = this.h % 360 + 360 * (this.h < 0),
        ...
        n = i + (i < .5 ? i : 1 - i) * e,
        r = 2 * i - n;
      return new M(_(t >= 240 ? t - 240 : t + 120, r, n), _(t, r, n), _(t < 120 ? t + 240 : t - 120, r, n), this.opacity);
    },
    clamp() {
    ...
    formatHsl() {
      const t = H(this.opacity);
      return `${1 === t ? "hsl(" : "hsla("}${S(this.h)}, ${100 * T(this.s)}%, ${100 * T(this.l)}%${1 === t ? ")" : `, ${t})`}`;
    }
  }));
  const z = Math.PI / 180,
    C = 180 / Math.PI,
  ...
  function G(t) {
    ...
    var e,
      ...
      r = W(t.g),
      a = W(t.b),
      s = Q((.2225045 * n + .7168786 * r + .0606169 * a) / 1);
    return n === r && r === a ? e = i = s : (e = Q((.4360747 * n + .3850649 * r + .1430804 * a) / L), i = Q((.0139322 * n + .0971045 * r + .7141733 * a) / A)), new K(116 * s - 16, 500 * (e - s), 200 * (s - i), t.opacity);
  }
  function J(t, e, i, n) {
  ...
  function Q(t) {
    return t > .008856451679035631 ? Math.pow(t, 1 / 3) : t / F + B;
  }
  function U(t) {
  ...
  function X(t) {
    ...
    if (t instanceof K || (t = G(t)), 0 === t.a && 0 === t.b) return new Z(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
  ...
  e(K, J, i(n, {
    ...
    rgb() {
      ...
      return new M(V(3.1338561 * (e = L * U(e)) - 1.6168667 * (t = 1 * U(t)) - .4906146 * (i = A * U(i))), V(-.9787684 * e + 1.9161415 * t + .033454 * i), V(.0719453 * e - .2289914 * t + 1.4052427 * i), this.opacity);
    }
  })), e(Z, Y, i(n, {
    brighter(t) {
  ...
  e(ct, ut, i(n, {
    brighter(t) {
      return t = null == t ? a : Math.pow(a, t), new ct(this.h, this.s, this.l * t, this.opacity);
    },
    darker(t) {
      return t = null == t ? r : Math.pow(r, t), new ct(this.h, this.s, this.l * t, this.opacity);
    },
    rgb() {
      var t = isNaN(this.h) ? 0 : (this.h + 120) * z,
        ...
        n = Math.cos(t),
        r = Math.sin(t);
      return new M(255 * (e + i * (et * n + it * r)), 255 * (e + i * (nt * n + rt * r)), 255 * (e + i * (at * n)), this.opacity);
    }
  })), t.color = m, t.cubehelix = ut, t.gray = function (t, e) {
    return new K(t, 0, 0, null == e ? 1 : e);
  }, t.hcl = Y, t.hsl = P, t.lab = J, t.lch = function (t, e, i, n) {
    return 1 === arguments.length ? X(t) : new Z(i, e, t, null == n ? 1 : n);
  }, t.rgb = x, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});